...
CPU::CPU() {
	...
	//   MNEMONIC        C  FUNC      SRC            DST                MNEMONIC      C  FUNC      SRC             DST                MNEMONIC       C  FUNC     SRC              DST                MNEMONIC      C  FUNC     SRC          DST                MNEMONIC        C  FUNC      SRC              DST                MNEMONIC      C  FUNC      SRC             DST                MNEMONIC       C  FUNC      SRC              DST                MNEMONIC      C  FUNC      SRC        DST
		...
		{"RET NZ",       2, &c::RET,  COND(COND_NZ), empt},            {"POP BC",     3, &c::POP,  R16STK(REG_BC), empt},            {"JP NZ, a16",  3, &c::JP,  a16,             COND(COND_NZ)},   {"JP a16",     4, &c::JP,  a16,         empt},            {"CALL NZ, a16", 3, &c::CALL, a16,             COND(COND_NZ)},   {"PUSH BC",    4, &c::PUSH, R16STK(REG_BC), empt},            {"ADD A, n8",   2, &c::ADD,  n8,              R8(REG_A)},       {"RST $00",    4, &c::RST,  VEC(0x00), empt},
		...
		{"RET NC",       2, &c::RET,  COND(COND_NC), empt},            {"POP DE",     3, &c::POP,  R16STK(REG_DE), empt},            {"JP NC, a16",  3, &c::JP,  a16,             COND(COND_NC)},   {"INVALID",    1, &c::INV, empt,        empt},            {"CALL NC, a16", 3, &c::CALL, a16,             COND(COND_NC)},   {"PUSH DE",    4, &c::PUSH, R16STK(REG_DE), empt},            {"SUB A, n8",   2, &c::SUB,  n8,              R8(REG_A)},       {"RST $10",    4, &c::RST,  VEC(0x10), empt},
		...
		{"LDH a8, A",    3, &c::LDH,  a8,            R8(REG_A)},       {"POP HL",     3, &c::POP,  R16STK(REG_HL), empt},            {"LDH [C], A",  2, &c::LDH, R8(REG_C),       R8(REG_A)},       {"INVALID",    1, &c::INV, empt,        empt},            {"INVALID",      1, &c::INV,  empt,            empt},            {"PUSH HL",    4, &c::PUSH, R16STK(REG_HL), empt},            {"AND A, n8",   2, &c::AND,  n8,              R8(REG_A)},       {"RST $20",    4, &c::RST,  VEC(0x20), empt},
		...
		{"LDH a8",       3, &c::LDH,  R8(REG_A),     a8},              {"POP AF",     3, &c::POP,  R16STK(REG_AF), empt},            {"LDH A, [C]",  2, &c::LDH, R8(REG_A),       R8(REG_C)},       {"DI",         1, &c::DI,  empt,        empt},            {"INVALID",      1, &c::INV,  empt,            empt},            {"PUSH AF",    4, &c::PUSH, R16STK(REG_AF), empt},            {"OR A, n8",    2, &c::OR,   n8,              R8(REG_A)},       {"RST $30",    4, &c::RST,  VEC(0x30), empt},
