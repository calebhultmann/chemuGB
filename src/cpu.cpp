...
CPU::CPU() {
	...
	//   MNEMONIC            B  FUNC      SRC            DST                MNEMONIC        B  FUNC      SRC             DST                MNEMONIC          B  FUNC     SRC              DST                MNEMONIC      B  FUNC     SRC          DST                MNEMONIC            B  FUNC      SRC              DST                MNEMONIC        B  FUNC      SRC             DST                MNEMONIC          B  FUNC      SRC              DST                MNEMONIC      B  FUNC      SRC        DST
		...
		{"JR C, $%04X",      2, &c::JR,   n8,            COND(COND_C)},    {"ADD HL, SP",   1, &c::ADD,  R16(REG_SP),    R16(REG_HL)},     {"LD A, [HL-]",    1, &c::LD,  R16MEM(REG_HLD), R8(REG_A)},       {"DEC SP",     1, &c::DEC, R16(REG_SP), empt},            {"INC A",            1, &c::INC,  R8(REG_A),       empt},            {"DEC A",        1, &c::DEC,  R8(REG_L),      empt},            {"LD A, $%02X",    2, &c::LD,   n8,              R8(REG_A)},       {"CCF",        1, &c::CCF,  empt,      empt},
